...
<head>
  ...
  <title>Admin Page - PT Alam Selaras</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/css/pages/pages.css">
      ...
      <div class="row">
        <div class="col-lg-6 offset-md-3">
          <div class="login-content bg-light">
            <div class="login-logo pt-4 pb-3 background-bg" data-image-src="<?php echo base_url();?>assets/img/longwayslogowhite.png">
              <a href="../index.html">
